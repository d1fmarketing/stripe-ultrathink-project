...
// src/handlers/getCharge.ts
var getCharge_exports = {};
__export(getCharge_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(getCharge_exports);
...
// src/handlers/getCharge.ts
var stripe = new stripe_esm_node_default(process.env.STRIPE_SECRET, { apiVersion: "2025-07-30.basil" });
async function handler(evt) {
  ...
  try {
    const ch = stripe_account_id ? await stripe.charges.retrieve(chargeId, { stripeAccount: stripe_account_id }) : await stripe.charges.retrieve(chargeId);
