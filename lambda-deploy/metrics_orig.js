...
var require_ms = __commonJS({
  "node_modules/ioredis/node_modules/ms/index.js"(exports2, module2) {
    var s = 1e3;
    var m = s * 60;
    var h = m * 60;
    var d = h * 24;
...
var require_common = __commonJS({
  "node_modules/ioredis/node_modules/debug/src/common.js"(exports2, module2) {
    function setup(env) {
...
var require_browser = __commonJS({
  "node_modules/ioredis/node_modules/debug/src/browser.js"(exports2, module2) {
...
var require_node = __commonJS({
  "node_modules/ioredis/node_modules/debug/src/node.js"(exports2, module2) {
    var tty = require("tty");
    var util = require("util");
    exports2.init = init;
    exports2.log = log;
...
var require_src = __commonJS({
  "node_modules/ioredis/node_modules/debug/src/index.js"(exports2, module2) {
...
var handler = async (event) => {
  ...
  try {
    const redis = new import_ioredis.default(process.env.REDIS_URL || "redis://localhost:6379", {
      lazyConnect: true,
    ...
    const cacheHitRate = totalCache > 0 ? parseFloat((hits / totalCache * 100).toFixed(1)) : 0;
    ...
    const latencyMetrics = {
      p50: 150,
      // Should track actual p50
      p95: 450,
      // Should track actual p95
      p99: 800,
      // Should track actual p99
      avg: 200
      // Should track actual average
    };
    const avgDisputeAmount = 140;
    const monthlyDisputes = 100;
