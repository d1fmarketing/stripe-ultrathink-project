...
// src/handlers/authLoginHandler.ts
var authLoginHandler_exports = {};
__export(authLoginHandler_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(authLoginHandler_exports);
var import_jsonwebtoken = __toESM(require_jsonwebtoken());
var JWT_SECRET = process.env.JWT_SECRET || "stripedshield-demo-secret-2025";
var JWT_EXPIRY = "7d";
var DEMO_USERS = [
  {
