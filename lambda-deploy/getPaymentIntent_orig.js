...
// src/handlers/getPaymentIntent.ts
...
async function handler(evt) {
  ...
  if (!charge?.payment_intent)
    return { ...evt, payment_intent: null };
  const pi = await stripe.paymentIntents.retrieve(charge.payment_intent, { stripeAccount: stripe_account_id });
